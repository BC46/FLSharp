...
FL_FUNC(bool EngAnimation::SetModel(PDWORD unk, const ModelBinary* model), setModelCallAddr);
...
bool EngAnimation::SetModel_Hook(PDWORD unk, const ModelBinary* model)
{
    const ModelBinary* currentModel = model;
