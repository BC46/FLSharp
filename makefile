...
CPP_FLAGS = /c /O2 /nologo /W3 /WX /GL /LD /MT /EHsc /Zc:threadSafeInit- /DNDEBUG /D_CRT_SECURE_NO_WARNINGS /D_CRT_NON_CONFORMING_SWPRINTFS /D_CRT_NONSTDC_NO_DEPRECATE /DUSE_ST6
LD_FLAGS = /LTCG /DLL /NOLOGO /RELEASE /DEBUG
